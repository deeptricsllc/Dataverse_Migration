 ...
 */
export function WizardSteps({ current, links = {} }: { current: number; links?: Partial<Record<number, string>> }) {
  return (
            ...
            >
              <span
                className={cx(
                  ...
                  active ? 'bg-white text-brand-700' : done ? 'bg-brand-100 text-brand-700' : 'bg-slate-200 text-slate-500',
                )}
              >
